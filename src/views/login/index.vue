    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left" v-if="loginFlag"> 
      ...
      <div class="erifycode-wrap-box">
        <el-form-item prop="verifycode" class="verifycode-input-box"> 
          <el-input v-model="loginForm.verifycode" placeholder="请输入验证码" class="identifyinput" @keyup.enter.native="handleLogin"></el-input>
        </el-form-item>
        <el-form-item  class="verifycode-btn-box"> 
          <div @click="refreshCode" class="verifycode-btn">
            <s-identify :identifyCode="identifyCode" :content-height="contentHeight"></s-identify>
          </div>
        </el-form-item>
      </div>
